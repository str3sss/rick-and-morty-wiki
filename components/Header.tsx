...
function Header() {
  return (
    <header className="fixed px-3 w-full flex justify-between bg-primary text-white text-bold text-sm sm:text-base z-10 sm:font-bold h-12 items-center pointer-events-auto">
      <Link href="/" className='hover:text-green before:content-["#"] before:mr-0.5 transition ease-in-out delay-75'>Home</Link>
